...
Original file is located at
    https://colab.research.google.com/drive/1M_B6zmSbZXzkyBApM5YO7DCypo0pDekw
"""
...
def main():
    ...
    def preprocess_function(examples):
        ...
        second_sentences = [
            [f"{header} {examples[context_name][i]}" for end in ending_names] for i, header in enumerate(question_headers)
        ]
        labels = examples[label_column_name]

        # Flatten out
        first_sentences = str(chain(*first_sentences))
        second_sentences = str(chain(*second_sentences))
